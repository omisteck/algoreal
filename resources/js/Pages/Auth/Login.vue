                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <inertia-link class="float-right font-size-13 text-muted" :href="'/forgot-password'">Forget Password?</inertia-link>
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="font-size-13 text-muted">
                                                    ...
                                                    <inertia-link class="small" :href="'/register'"> Signup</inertia-link>
                                                </span>
